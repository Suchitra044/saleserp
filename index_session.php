	  	...
	  	<div id="content">
			...
			<div class="stuff">
				<div class="item">
					...
					<a href="index2.html" class="name">sony</a>
					<span>rs.14000</span>
		<a href="cart.php?action=add&id=1"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
				<div class="item">
					<img src="images/pic2.jpg" alt="" width="124" height="111" /> 
<a href="index2.html" class="name">Name kodak</a><span>rs.15000</span>
<a href="cart.php?action=add&id=2"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
				<div class="item">
					<img src="images/ph1.jpg" alt="" width="124" height="89" />
					<a href="index2.html" class="name">samsung</a>
					<span>rs.3400</span>
					<a href="cart.php?action=add&id=7"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
				<div class="item">
					<img src="images/ph2.jpg" alt="" width="124" height="89" />
					<a href="index2.html" class="name">samsung</a>
					<span>rs.3500</span>
					<a href="cart.php?action=add&id=72"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
				<div class="item">
					<img src="images/lap1.jpg" alt="" width="124" height="97" />
				...
				<div class="item">
					...
					<a href="index2.html" class="name">dell inspiron</a>
					<span>rs.38000</span>
