...
<a href="cart.php?action=add&id=14"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				...
				<div class="item">
					<img src="images/lap3.jpg" alt="" width="124" height="89" />
					<a href="index2.html" class="name">hp</a>
					<span>rs.40000</span>
					<a href="cart.php?action=add&id=15"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
				<div class="item">
					<img src="images/lap4.jpg" alt="" width="124" height="89" />
					<a href="index2.html" class="name">sony</a>
					<span>rs.35800</span>
					<a href="cart.php?action=add&id=16"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
				<div class="item">
					<img src="images/lap5.jpg" alt="" width="124" height="97" />
					<a href="index2.html" class="name">hp</a>
					<span>rs.36000</span>
					<a href="cart.php?action=add&id=17"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
				<div class="item">
					<img src="images/lap6.jpg" alt="" width="124" height="111" />
					<a href="index2.html" class="name">lenovo</a>
					<span>rs.34000</span>
					<a href="cart.php?action=add&id=18"><img src="images/cart.gif" alt="" width="71" height="19" /></a>
				</div>
			</div>
		</div>
	  </div>
